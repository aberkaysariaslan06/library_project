...
public class UserRepository {
    ...
    private int nextId(){ //yeni bir kullanıcı, admin veya müşteri oluşturulacağı zaman çakışmayan, benzersiz bir ID atamak için kullanılır.
        if(lastId == 0) {
...
/*
    ...
    public boolean matchesCustomer(Customer c, String[] terms) {
        ...
        for(String t : terms) {
            boolean hit =
                    idStr.contains(t) || username.contains(t) || firstName.contains(t) || lastName.contains(t) || email.contains(t)||
    ...
    private String safe (String str) { //bu metot null olan stringleri kontrol eder ve null ise boş string döner, yoksa lowercase çevirir.
