...
public interface UserService {
    ...
    List<Customer> searchUsers(String searchTerm); // System User kullanmadik sonucta biz adminleri degil sadece
                                                   // customerlari search edebilecegiz.

    // tek bir seyi almak istedigimizde ve null gibi bir durum ile ugrasmak
    // istemedigimizde Optional kullanabiliriz.
